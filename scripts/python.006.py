...
OUTPUT_DIR = Path("scripts/assets/generated/apps")
ICON_CACHE_DIR = Path("scripts/assets/ironfox_assets")
...
def get_latest_beta_version():
    ...
    versions.sort(key=lambda v: [int(x) for x in re.split(r'\.|b', v)])
    return versions[-1]
